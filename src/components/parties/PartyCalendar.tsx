...
const SAMPLE_BOOKINGS: PartyBooking[] = [
  {
    id: 'booking_1',
    date: formatLocalDate(new Date(Date.now() + 2 * 24 * 60 * 60 * 1000)), // 2 days from now
    startTime: '13:00',
    endTime: '15:00',
    duration: 2,
  ...
  {
    id: 'booking_2',
    date: formatLocalDate(new Date(Date.now() + 5 * 24 * 60 * 60 * 1000)), // 5 days from now
    startTime: '16:00',
    endTime: '18:00',
    duration: 2,
  ...
  {
    id: 'booking_3',
    date: formatLocalDate(new Date(Date.now() + 9 * 24 * 60 * 60 * 1000)), // 9 days from now
    startTime: '12:00',
    endTime: '14:00',
    duration: 2,
  ...
  {
    id: 'booking_4',
    date: formatLocalDate(new Date(Date.now() + 12 * 24 * 60 * 60 * 1000)), // 12 days from now
    startTime: '15:00',
    endTime: '17:00',
    duration: 2,
