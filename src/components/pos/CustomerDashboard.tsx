    ...
    const loadProducts = () => {
      ...
      try {
        ...
        const formattedParties = parties.map(party => ({
          ...
          description: `${party.description} (Can accommodate up to ${party.capacity} kids with an additional charge of $15/child over the included ${party.name.toLowerCase().includes('queen') ? 20 : 15}, ${party.duration} hours)`,
          sessions: 1,
